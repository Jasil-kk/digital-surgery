...
export default function Hero() {
  ...
  return (
    <section
      ref={sectionRef}
      className="w-full min-h-80 px-[5%] sm:px-[8%] relative text-white flex items-center text-center overflow-hidden"
    >
      ...
      <div
        style={{
          backgroundImage: 'url("/images/media-single/hero-frame.png")',
          backgroundSize: "cover",
          backgroundPosition: "center",
        }}
        className="absolute top-0 left-0 w-full h-full -z-10"
      />
      <div className="absolute top-0 left-0 w-full h-full bg-[#041a4973] -z-10" />
    </section>
  );
}
